---
name: pyjobshop-scheduling
description: PyJobShop constraint programming production scheduling (job shop / flexible job shop).
---

# pyjobshop-scheduling (upstream material)

> Vendored pointer skill. Source: https://cdn.jsdelivr.net/gh/PyJobShop/PyJobShop@main/README.md
> OR-Path numbers authority remains `tools/solve_*` + validate unless you explicitly switch engines.

Install: `pip install pyjobshop`.
