---
name: pyvrp-engine
description: PyVRP state-of-the-art VRP solver (HGS). Use for vehicle routing beyond basic OR-Tools Routing demos.
---

# pyvrp-engine (upstream material)

> Vendored pointer skill. Source: https://cdn.jsdelivr.net/gh/PyVRP/PyVRP@main/README.md
> OR-Path numbers authority remains `tools/solve_*` + validate unless you explicitly switch engines.

Install: `pip install pyvrp`. Import: `import pyvrp`. Not default claim ladder (ortools remains VRP demo track).
