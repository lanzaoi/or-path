---
name: vrplib-instances
description: VRPLIB read/write standard VRP benchmark instances for experiments and gates.
---

# vrplib-instances (upstream material)

> Vendored pointer skill. Source: https://cdn.jsdelivr.net/gh/PyVRP/VRPLIB@main/README.md
> OR-Path numbers authority remains `tools/solve_*` + validate unless you explicitly switch engines.

Install: `pip install vrplib`.
